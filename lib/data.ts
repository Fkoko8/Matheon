...
export function getQuestions(topicId?: string): Question[] { return [{ id: 'question-logarithm', topicId: 'topic-1', title: 'Równanie logarytmiczne', prompt: 'Rozwiąż równanie log₂(x − 1) = 3.', difficulty: 'medium', points: 3 }, { id: 'question-sequence', topicId: 'topic-5', title: 'Ciąg arytmetyczny', prompt: 'Wyznacz wyraz a₁₀ ciągu, w którym a₃ = 7 oraz a₇ = 19.', difficulty: 'hard', points: 4 }, { id: 'question-triangle', topicId: 'topic-5', title: 'Pole trójkąta', prompt: 'Oblicz pole trójkąta o podstawie 8 i wysokości 5.', difficulty: 'easy', points: 2 }].filter((question) => !topicId || question.topicId === topicId) }
